...
function Todo() {
    ...
    const tabs = {
        add: (
            <div className="py-[12px] w-[70%] m-auto text-center bg-[#FEF3C7] text-[#1F2937] rounded-b-xl">
                <h1 className="font-bold text-[18px]">add task</h1>
                <p className="mr-[29%]">task*</p>
                <input type="text" value={task}  className="focus:outline-none w-[250px] h-[30px] px-[12px] bg-[#fff]" onChange={(e) => setTask(e.target.value)} />{" "}
                <br />
